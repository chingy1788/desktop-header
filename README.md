...
- **Per-Desktop Sticky Notes**: Includes an expandable notes dropdown on the right side of the screen. When collapsed, it shows a low-profile preview of the first line. Clicking it expands a beautiful dark glassmorphic text editor that auto-saves your notes per virtual desktop based on their unique COM GUIDs.
